...
export const Wrapper = tw.section`mx-auto w-full py-[4vh] snap-always snap-center mx-auto px-6 md:px-0`;
export const InnerWrap = tw.div`mx-auto max-w-5xl w-full flex items-center justify-center flex-col`;
