...
export const Heading = tw.h2`text-5xl font-medium tracking-tighter pt-3 font-newsreader`;
export const SubHeading = tw.h3`text-lg md:text-2xl lg:text-3xl tracking-tight balanced font-medium font-body pt-1`;
